...
aggdemand(300)# new carbon price is 34.04228 

newcarbonprice<- function(x){x=aggdemand(300)}
...
anewnetbentax<- anewpolbenefittax$value - (newainter$x*newainter$y)
...
bnewnetbentax<- bnewpolbenefittax$value - (newbinter$x*newbinter$y)
...
cnewnetbentax<- cnewpolbenefittax$value - (newcinter$x*newcinter$y)
...
a2permitneed+c2permitneed #need 67.69892 permits 

(300-newdinter$x)+(100-newbinter$x)# have 118.1023 permits to sell

#too many permits in market, not worth it to invite country Y to carbon trade market because either B would be left with permits or D would


dlonelybenefit<- integrate(demand_D, 0,300)

dtradebenefit <- dlonelybenefit$value-(300-newdinter$x)*aggdemand(300) # if they sell all permits, not even worth it because they make 14602.99 by themselves and only 11413.29 if they trade and sell all. 
